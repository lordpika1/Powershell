...
$resetPwdBody = @"
    {
      "query": {
        "bool": {
          "must": [
             {
             "match_phrase": {"event.action": "Reset user password."}
             },
             {
...
$scroll = $false
$searchResults = Invoke-RestMethod -Uri "https://$ip:9200/so-o365-$year.*/_search?size=10000&scroll=1m" -Headers $header -Method post -Body $resetPwdBody -ContentType "application/json" -UseBasicParsing
...
if ($result._source.o365.audit.UserId -match "fim_*"){
...
$($result._source.o365.audit.ObjectId) had their password reset by $($result._source.o365.audit.UserId) at $eventTime
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUDOU2LJP4kpJVlGPy0g3fdBTn
# QDSggiGyMIIDJzCCAg+gAwIBAgIQa066y01m+bBONwK13T0+hTANBgkqhkiG9w0B
...
# BgorBgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQU5TcA
# sC6Ulhys1hZyp3AiDiOvZfUwDQYJKoZIhvcNAQEBBQAEggIAKfg1xkXhqN3i3Djf
# znKRbDx3cznwfKev6xtuwqp2/GsCkBt0yD6IZoWhqV6xV6tb+JNd4ZaNqgbAeSE1
# Ao23jkdh5/cFBzCe/Z/keKww4AGhIPmDm+kh/DB50g8qtWDmJlJRMiJKIcdtsvfs
# 1WzLKMCyix2f/DT7bi9Y9hwY5hgLxsBvHl2gYkJ6hLKNYruEiZcj3bz2EMOlbjHd
# X1Bp6+G9wU2Mj1mqFaH6Kkt51S1GtIoK/JjYDdcmiBPnZynnXLzYLZJlKljH+wnn
# mehaKui7QHwHwr6zKulvUYvMS2AnnPcOdvsOlrT1MnqQ9ubqr5ayJOe4/lIQFal4
# wljy7SA1upZtlMz6lEU95/NhnOP5lAE3S00VoUjCTKAuUAKZz4ti1pD9RJWT/t60
# Nu4fzJQqKrcaKe4EAnXFKHdcMNCLFbrZ4flL7sox8XfZ/yauhaFu+qnx74Itcyzk
# WwEZEKGBLLi4bYqgG7jqr2vVAPWhKgKSjG/lb52QJHSB4EY1HvMsRRv5ycpBMILS
# J04nbIwyoU2v6ESw01oRu1CZ08lAvLK6D5nMJTGCLxSRU8zbOe685Tm2bGoxc0le
# rh61Do5GCoAe16qxYt4PRTYb+q8W+UXFULwSzNTgQeqW40U24sbm41NPnKSxLK2s
# Idp72smvZwu7i15Zy+mDCqOfFDGhggNsMIIDaAYJKoZIhvcNAQkGMYIDWTCCA1UC
...
# AzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTIzMDQwMzEzNDYzNFowKwYJ
# KoZIhvcNAQk0MR4wHDALBglghkgBZQMEAgGhDQYJKoZIhvcNAQELBQAwLwYJKoZI
# hvcNAQkEMSIEIJxMuy/ZbVXEXlEYIkweawr/Vv/aCMYrAMt6UdbFDjSMMIGkBgsq
...
# EAFIkD3CirynoRlNDBxXuCkwDQYJKoZIhvcNAQELBQAEggGADg95jI47z6IKu1+1
# LS7FXPFqDBoO4Fd8PVw6TATtTkuNwqDJ+6RGxGrwpN9Q5PkKJLCAP3y4ILDPvG2+
# Pnkqf2UusVEh9WwEj0ld1x+ygsJMXo8sP8v9TGQn+FUtqI7B/jew6UPKZXgb+JiJ
# Wpr6dEaDO5/OFfkQR1cN0/sF/iN+M0w9NwgXhSd1eYTpZLYH3WTR4K1ZTkYfb7ls
# tsK8cfqIWjtyp2RYZ1hhoAbBSb6uc9VWjn9xOeuZP1dAkWs9vMKEpMQ4u+Kr7txx
# +KIgnq5/zvN/GcD1wZP/oKrilmdDsUyWnXYDRMyZJj7znofgWvwA3cbAjIutSbxG
# AZe92GNmJbn55BwdYvHCbVdQu8pEpDB59BBXWMzTQoM+kF4InO9oUbGfRP5HuJGP
# 3HxOVpzT9q6wScKYQ5MQ7htSLsHFm9DaHdZCVNZTrShsfQ0fnhDjnoQCsAz0Ej5p
# TKYb8QVO/Jjto2cuudP4uV1OmALtomqyfKBkagcnPKqayNgf
